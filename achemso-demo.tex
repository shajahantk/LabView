...
\includegraphics[width=\linewidth,height=0.6\linewidth]{Dc_frntpnl - Copy.png}
    ...
    \label{fig:ex3}
\end{figure}
The part I of the front panel contains following icons:
\begin{itemize}
...
\end{itemize}
     ...
     Part I will stop and part two of the program
...
voltage signal. We use the channeli analog output 0 (AO 0) of the DAQ
...
The block diagram corresponding to this front panel is shown in \ref{fig:ex4}. 
